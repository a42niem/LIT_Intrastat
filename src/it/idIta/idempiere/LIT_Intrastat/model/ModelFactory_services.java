...
public class ModelFactory_services implements IModelFactory {
	...
	public Class<?> getClass(String tableName) {
		...
		if (X_LIT_VAT_Summary.Table_Name.equals(tableName))
			return X_LIT_VAT_Summary.class;
		else if (X_LIT_InvoiceIntrastat.Table_Name.equals(tableName))
	...
	public PO getPO(String tableName, int Record_ID, String trxName) {
		...
		if (X_LIT_VAT_Summary.Table_Name.equals(tableName))
			return new X_LIT_VAT_Summary(Env.getCtx(), Record_ID, trxName);
		else if (X_LIT_InvoiceIntrastat.Table_Name.equals(tableName))
	...
	public PO getPO(String tableName, ResultSet rs, String trxName) {
		...
		if (X_LIT_VAT_Summary.Table_Name.equals(tableName))
			return new X_LIT_VAT_Summary(Env.getCtx(), rs, trxName);
		else if (X_LIT_InvoiceIntrastat.Table_Name.equals(tableName))
